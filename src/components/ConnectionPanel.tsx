            ...
            <div className="flex items-center justify-between bg-green-50 border border-green-200 rounded-lg p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-green-700">{hubDomain}</p>
                </div>
              </div>
              <button
          ...
          {isWixConnected ? (
            <div className="flex items-center justify-between bg-green-50 border border-green-200 rounded-lg p-4">
              <div className="flex items-center gap-3">
                <CheckCircle2 className="w-6 h-6 text-green-600" />
                <div>
                  <p className="text-sm font-medium text-green-900">Connected to Wix</p>
                  <p className="text-xs text-green-700">Active Connection</p>
                </div>
              </div>
              <button
            ...
            <div className="flex items-center justify-between bg-neutral-bg border border-neutral-border rounded-lg p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-medium text-neutral-text">Not Connected</p>
                  <p className="text-xs text-neutral-subtext">Authorize WixHub Sync to access your Wix data.</p>
                </div>
              </div>
              <button
                onClick={handleConnectWix}
                className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-brand-blue-main rounded-lg hover:bg-brand-blue-light transition-colors shadow-sm"
              >
                <LinkIcon className="w-4 h-4" />
                Connect Wix
              </button>
