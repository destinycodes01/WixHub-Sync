      ...
      <div className="p-4 md:p-6 space-y-8">
        ...
        <div>
          <h3 className="text-md font-medium text-neutral-text mb-3 flex items-center gap-2">
            <span className="flex items-center justify-center shrink-0 w-6 h-6 rounded-full bg-brand-blue-main/10 text-brand-blue-main text-sm font-bold">1</span>
            Use Wix Automations (Recommended)
          </h3>
          <p className="text-sm text-neutral-subtext mb-4 ml-0 md:ml-8">
          ...
          <div className="ml-0 md:ml-8 flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
            <div className="flex-1 bg-neutral-bg border border-neutral-border rounded-lg px-4 py-3 font-mono text-xs md:text-sm text-neutral-text truncate">
              {webhookUrl}
            </div>
            <button
              onClick={handleCopy}
              className="w-full sm:w-auto flex justify-center items-center gap-2 px-4 py-3 text-sm font-medium text-white bg-brand-blue-main rounded-lg hover:bg-brand-blue-light transition-colors shadow-sm shrink-0"
            >
        ...
        <div>
          <h3 className="text-md font-medium text-neutral-text mb-3 flex items-center gap-2">
            <span className="flex items-center justify-center shrink-0 w-6 h-6 rounded-full bg-brand-blue-main/10 text-brand-blue-main text-sm font-bold">2</span>
            Embed HubSpot Form
          </h3>
          <p className="text-sm text-neutral-subtext mb-4 ml-0 md:ml-8">
          ...
          <div className="ml-0 md:ml-8 bg-gray-900 rounded-lg p-4 relative group overflow-x-auto w-full">
            <pre className="text-xs md:text-sm text-gray-300 font-mono whitespace-pre-wrap word-break">
